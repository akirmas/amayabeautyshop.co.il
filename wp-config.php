...
define('DB_NAME', 'shop_he');

/** MySQL database username */
define('DB_USER', 'shop_wp3');

/** MySQL database password */
define('DB_PASSWORD', 'J.AkckFtkVMycWfLVXM53');
...
define('WP_HOME','https://amayabeautyshop.co.il' );
define('WP_SITEURL','https://amayabeautyshop.co.il' );
